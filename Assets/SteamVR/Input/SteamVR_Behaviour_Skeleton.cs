...
namespace Valve.VR
{
    public class SteamVR_Behaviour_Skeleton : MonoBehaviour
    {
        ...
        // カメラの回転を利用するため。カメラの回転の逆回転をコントローラーに掛けることで、ユーザーの回転を打ち消す。
        ...
        */
        ...
        protected virtual void UpdatePose()
        {
            ...
            // // カメラの逆回転を適用
            // skeletonRotation =  Quaternion.Euler(0, -cameraRotation.eulerAngles.y, 0) * skeletonRotation;
